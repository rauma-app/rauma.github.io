    ...
    <footer className="mt-16 bg-navy text-cream/80">
      <div className="mx-auto max-w-6xl px-4 py-10">
        <div className="grid gap-10 sm:grid-cols-[1.3fr_1fr_1.3fr]">
          ...
          {/* Kolom 3: Download Aplikasi (Berdampingan) & Hubungi Kami */}
          <div>
            <div>
              <p className="text-sm font-semibold text-white">Download Aplikasi Kami</p>
              {/* Menggunakan flex-row agar berdampingan kiri-kanan */}
              <div className="mt-3 flex flex-row gap-3">
                {/* Tombol App Store Mockup */}
                <a
                  href="#"
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-2 rounded-lg bg-black px-3 py-2 text-white border border-neutral-700 hover:bg-neutral-900 transition-colors"
                >
                  ...
                  <div className="text-left">
                    <p className="text-[9px] uppercase leading-tight text-neutral-400">Download di</p>
                    <p className="text-xs font-medium leading-tight">App Store</p>
                  </div>
                </a>

                {/* Tombol Google Play Mockup */}
                <a
                  href="#"
                  target="_blank"
                  rel="noreferrer"
                ...
                >
                  ...
                  <div className="text-left">
                    <p className="text-[9px] uppercase leading-tight text-neutral-400">Temukan di</p>
        ...
        {/* Copyright (Dipindah ke tengah menggunakan text-center) */}
