...
export default function Footer() {
  ...
  <div className="mt-3 flex flex-wrap gap-3">
    ...
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="flex items-center gap-2 rounded-lg bg-black px-4 py-2 text-white border border-neutral-700 hover:bg-neutral-900 transition-colors"
    >
      ...
      <div className="text-left">
        <p className="text-[10px] uppercase leading-tight text-neutral-400">Download di</p>
    ...
    >
      ...
      <div className="text-left">
        <p className="text-[10px] uppercase leading-tight text-neutral-400">Temukan di</p>
